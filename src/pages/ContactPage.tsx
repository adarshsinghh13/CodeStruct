                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <a href="mailto:adarshsinghh13@gmail.com" className="text-dsa-purple hover:underline">
                        adarshsinghh13@gmail.com
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <a href="https://www.linkedin.com/in/adarshsinghh13" target="_blank" rel="noopener noreferrer" className="text-dsa-purple hover:underline">
                        adarshsinghh13
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <a href="https://github.com/adarshsinghh13" target="_blank" rel="noopener noreferrer" className="text-dsa-purple hover:underline">
                        adarshsinghh13
                      </a>
                    </div>
                  </div>
              ...
              <CardContent className="pt-6">
                ...
                <div className="flex gap-3 mt-4">
                  <Button variant="outline" className="flex-1" asChild>
                    <a href="https://github.com/adarshsinghh13" target="_blank" rel="noopener noreferrer">
                      <Github className="mr-2 h-4 w-4" /> GitHub
                    </a>
                  </Button>
                  <Button variant="outline" className="flex-1" asChild>
                    <a href="https://www.linkedin.com/in/adarshsinghh13" target="_blank" rel="noopener noreferrer">
