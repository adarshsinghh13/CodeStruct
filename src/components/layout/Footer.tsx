    ...
    <footer className="border-t border-border">
      <div className="container py-8 px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center gap-2">
              <span className="text-2xl font-bold bg-gradient-to-r from-dsa-purple to-dsa-purple-light bg-clip-text text-transparent">CodeStruct</span>
            </Link>
            ...
            <div className="flex mt-6 space-x-4">
              ...
              <a 
                href="mailto:adarshsinghh13@gmail.com" 
                className="text-muted-foreground hover:text-foreground transition-colors"
              >
        ...
        <div className="border-t border-border mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm">&copy; {new Date().getFullYear()} CodeStruct. All rights reserved.</p>
          <div className="flex items-center space-x-4 mt-4 md:mt-0">
            <span className="text-sm text-muted-foreground">Created by <a href="https://github.com/adarshsinghh13" className="text-dsa-purple hover:underline">Adarsh Singh</a></span>
          </div>
        </div>
      </div>
    </footer>
